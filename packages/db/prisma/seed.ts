...
const tags = [
  ...
  { name: "知性", category: "MOOD" },
  { name: "可愛", category: "MOOD" },
];
...
const exhibitions = [
  ...
  },
  {
    ...
    tagNames: ["日本當代藝術", "當代藝術", "攝影", "雕塑", "絢爛", "好拍"],
  },
  {
